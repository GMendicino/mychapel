...
import { type Project, type Admin, listProjects, saveProjects, listAdmins, deleteTour, reassignTour, deleteAdmin
} from "./script/storage";
...
// Simple password gen (to be replaced with real system once deployed)
                ...
                <aside className={leftBarStyles.sidebar}>
                    ...
                    <div className={leftBarStyles.sidebarBox}>
                        <div style={{ display: "grid", gap: "0.75rem" }}>
                            <a href="https://mychapel.pages.dev/" className={styles.secondaryBtn} style={{ textAlign: "center" }}>
                                Back To Website
                            </a>
                            <div
                                style={{
                                    ...
                                    >
                                        ...
                                        <div className={styles.cardContent}>
                                            ...
                                            <div className={styles.cardMetaRow}>
                                                <span className={styles.adminBadge}>{"\u{1F464}"} {p.admin}</span>
                                                <span className={styles.sceneCount}>
                                                    {"\u{1F4F7}"} {p.tour?.createdPanoNodes?.length || 0} Scenes
                                                </span>
                                            </div>
                                            <button
